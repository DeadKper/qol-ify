...
---@param text string
function _re.msg(text) end

---Calls func when scripts are being reset. Useful for cleaning up stuff. Calls on_config_save().
---@param func function
function _re.on_script_reset(func) end

---Called when REFramework wants to save its config.
---@param func function
function _re.on_config_save(func) end
...
---@param func function
function _re.on_draw_ui(func) end
...
---@param func function
function _re.on_frame(func) end

---Prelude of ```on_application_entry```
---@param name ModuleEntry
---@param func function
function _re.on_pre_application_entry(name, func) end
...
---@param name ModuleEntry
---@param func function
function _re.on_application_entry(name, func) end

---Prelude of ```on_gui_draw_element```
---@param func function
function _re.on_pre_gui_draw_element(func) end
...
---```
---@param func function
function _re.on_gui_draw_element(func) end
